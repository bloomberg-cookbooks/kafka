...
# @since 1.0.0
class Chef::Resource::KafkaService < Chef::Resource
  include Poise
  ...
  # @return [String]
  attribute(:config_path, kind_of: String, default: '/etc/kafka/kafka.cfg')
...
# @since 1.0.0
class Chef::Provider::KafkaService < Chef::Provider
  include Poise
  provides(:kafka_service)
  include PoiseService::ServiceMixin
